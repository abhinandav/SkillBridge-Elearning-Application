                    ...
                    <tbody>
                      ...
                      {filteredTeachers.map((user) => (
                        <tr key={user.id}>
                          ...
                          {user.is_active ? (
                          <>
                          <span onClick={() => showBlockModal(user.id)}  className="bg-red-600 px-2 py-2 rounded-md  ml-3 text-white font-semibold tracking-wide cursor-pointer">Block</span>
                                {/* Block User Modal */}
                                {showBModal && (
                            ...
                            <>
                            <span onClick={() => showUBlockModal(user.id)}  className="bg-green-600 px-2 py-2 rounded-md  ml-3 text-white font-semibold tracking-wide cursor-pointer">Unblock</span>
                                    ...
                                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                      <div className="sm:flex sm:items-start">
                                        <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-green-100 sm:mx-0 sm:h-10 sm:w-10">
                                          {/* You can add any icon or indicator here */}
                                        </div>
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                          <h3 className="text-lg leading-6 font-medium text-gray-900" id="modal-headline">
                                            Unblock User
