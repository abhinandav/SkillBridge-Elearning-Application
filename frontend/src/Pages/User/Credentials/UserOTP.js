...
//     const inputRefs = Array.from({ length: 4 }, (_, i) => React.createRef());
...
//     if (value !== '' && index < otpValues.length - 1 && inputRefs[index + 1]?.current) {
...
//     console.log('Request payload:', { email: registeredEmail, otp: enteredOtp });
//     try {
//         const res = await axios.post(baseURL+'/api/accounts/userotp/', { email: registeredEmail, otp: enteredOtp });
//         if (res.status == 200) {
//             console.log('verified');
//           navigate('/login'); 
//         } 
...
//                 <div className="w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-7/12">
//                     <div className="flex flex-col items-center justify-center w-full h-full relative lg:pr-10 mr-10" >
//                         <img src="https://img.freepik.com/free-vector/college-entrance-exam-concept-illustration_114360-13742.jpg?w=740&t=st=1709633300~exp=1709633900~hmac=c153fcf71de0a144bc3792f0a01e386c95d823c570cf1c9957fb05353274c092" alt="Health Run" className="btn-"  style={{marginRight:100, height:500}}/>
//                     </div>
//                 </div>
//                     {/* Right Section (Sign-up Form) */}
//                 <div className=" flex min-h-screen flex-col justify-center overflow-hidden bg-white-50 py-12 -20" style={{marginTop:-70}}>
//                     <div className="relative bg-white px-6  pb-9 shadow-xl mx-auto w-full max-w-lg rounded-2xl">
//                         <div className="mx-auto flex w-full max-w-md flex-col space-y-16">
//                             <div className="flex flex-col items-center justify-center text-center space-y-2">
//                                 <div className="font-semibold text-3xl">
//                                     <p>Email Verification</p>
