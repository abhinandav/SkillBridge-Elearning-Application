    ...
    <>
      ...
      <div className="container mx-auto px-6 py-16 pt-28 text-center">
        <div className="mx-auto max-w-lg">
          ...
          "Unveil the Path to Limitless Possibilities."
          </h1>
          ...
          <div className="mx-auto mt-6 w-full max-w-sm rounded-md border bg-transparent focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 focus-within:ring-opacity-40 dark:border-gray-700 dark:focus-within:border-blue-300">
            <form className="flex flex-col md:flex-row">
              ...
              <button
                type="button"
                className="m-1 h-10 transform rounded-md bg-orange-500 px-4 py-2 text-white transition-colors duration-300 hover:bg-blue-400 focus:bg-blue-400 focus:outline-none"
              >
                Join Us
              </button>
            </form>
        ...
        <div className="mx-auto mt-28 max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              ...
              <div class="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
              <svg className="h-10 fill-current text-gray-500 " xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 316 60">
